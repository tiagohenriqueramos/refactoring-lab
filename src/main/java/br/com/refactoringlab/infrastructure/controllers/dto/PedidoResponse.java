...
public record PedidoResponse(String id, Long codigoInterno, StatusPedido statusPedido,
                             StatusOcorrencia statusUltimaOcorrencia) {
    public static PedidoResponse from(Pedido pedido) {
        return new PedidoResponse(pedido.getId(), pedido.getCodigoInterno(), pedido.getStatusPedido(), pedido.getStatusUltimaOcorrencia());
    }
}
